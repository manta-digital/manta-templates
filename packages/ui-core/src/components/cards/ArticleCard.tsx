    ...
    <MotionDiv className="h-full w-full" {...motionProps}>
      <Link href={href} className={cn('group block h-full w-full', className)} {...props}>
        <BaseCard className="relative h-full w-full overflow-hidden p-0 m-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black via-black/90 to-transparent pointer-events-none z-20" />
          <div className="absolute bottom-0 left-0 right-0 p-4 pb-6 sm:p-5 md:p-6 text-white pointer-events-none z-20">
            {subtitle && (
