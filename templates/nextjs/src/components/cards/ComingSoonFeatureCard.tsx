...
export default function ComingSoonFeatureCard({ mode = 'dark', content }: ComingSoonFeatureCardProps) {
  ...
  const textClasses = mode === 'light' ? {
    ...
    icons: 'text-[var(--color-accent-11)]',
    comingSoonBadge: 'bg-[var(--color-accent-3)] text-[var(--color-accent-12)] border-[var(--color-card-border)]',
    primaryButton: 'bg-gradient-to-r from-[var(--color-accent-9)] to-[var(--color-accent-10)] hover:from-[var(--color-accent-10)] hover:to-[var(--color-accent-11)]',
    ...
    icons: 'text-[var(--color-accent-11)]',
    comingSoonBadge: 'bg-[var(--color-accent-4)]/40 text-[var(--color-accent-11)] border-[var(--color-card-border)]/50',
    primaryButton: 'bg-gradient-to-r from-[var(--color-accent-9)]/70 to-[var(--color-accent-10)]/80 hover:from-[var(--color-accent-10)] hover:to-[var(--color-accent-11)]',
    secondaryButton: 'bg-slate-800 text-slate-200 hover:bg-slate-700 border-slate-700',
    backgroundGradient: 'bg-gradient-to-r from-[var(--color-accent-9)]/20 to-[var(--color-accent-10)]/20',
    animatedDots: 'bg-[var(--color-accent-11)]',
  };
