...
export default function GuidesFeatureCard({ mode = 'dark', content }: GuidesFeatureCardProps) {
  ...
  const textClasses = mode === 'light' ? {
    ...
    sectionTitle: 'text-card-foreground',
    description: 'text-muted-foreground',
    links: 'text-muted-foreground hover:text-[var(--color-accent-10)]',
    divider: 'border-[var(--color-card-border)]',
    icons: 'text-[var(--color-accent-9)]',
    cardBg: 'bg-[var(--color-accent-a2)] hover:bg-[var(--color-accent-a3)]',
    cardBorder: 'border-[var(--color-card-border)]',
    cardText: 'text-[var(--color-accent-9)] group-hover:text-[var(--color-accent-10)]',
    cardDescription: 'text-muted-foreground',
    cardAction: 'text-[var(--color-accent-10)]',
    footerButton: 'bg-[var(--color-accent-a3)] text-[var(--color-accent-11)] hover:bg-[var(--color-accent-a4)]',
    codeBlock: 'bg-[var(--color-accent-a2)]',
    codeText: 'text-card-foreground',
  };
