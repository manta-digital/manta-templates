...
##### Output Location
Save the completed specification document as `spec.{project}.md` in the `project-documents/private/project-guides/` directory, where `{project}` is your project name.
