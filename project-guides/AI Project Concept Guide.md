This guide will assist us in creating a project concept, allowing us to describe projects using a consistent format and increasing our chances of completing them successfully.  This Concept is Phase 1 in our AI Project Guide.  If you do not have access to that guide, stop now and request it from the Project Manager.
