...
description: Rules applies to any testing related tasks or test generation.
globs:
---
...
- After a complex task is performed, use the `codeReview` tool create a diff and use the diff to conduct a code review of the changes. # Testing & Development Tools
